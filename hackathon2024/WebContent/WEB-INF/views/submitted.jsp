...
<link href="https://fonts.googleapis.com/css2?family=Source+Serif+4:wght@300&display=swap" rel="stylesheet">
  ...
  <div class="row">
      ...
      <div>
            <div style="padding-left:300px" class="col-12 col-sm-12 col-md-8">
  
              <!-- Image -->
              <img alt="" class="img-fluid mb-6 mb-md-0 animate__bounceIn" src="https://i0.wp.com/academicprojectworld.com/wp-content/uploads/2020/04/referral-email-payment-completed-1024x525-1.jpg" />
